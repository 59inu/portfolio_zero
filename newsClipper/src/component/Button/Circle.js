...
const Circle = ({setSource}) => {
  ...
  const RefCircleBtn = React.useRef();
  const handleOnPress = () => {
    switch (isOpen) {
      case false:
        setOpen(true);
      ...
      <View
        ...
        <Animated.View
          ...
          <InCircleItem
            ...
            size={65}
            containerSize={400}
            iconStyle={{name: searchFrom.google, size: 40, color: 'black'}}
            onPress={() => {
              setAPIsource(searchFrom.google);
              handleOnPress();
            }}
          />
          <InCircleItem
            ...
            size={65}
            containerSize={400}
            iconStyle={{name: searchFrom.nyt, size: 40, color: 'black'}}
            onPress={() => {
              setSource(searchFrom.nyt);
              handleOnPress();
            }}
          />
          <InCircleItem
            ...
            size={65}
            containerSize={400}
            iconStyle={{name: searchFrom.naver, size: 40, color: 'black'}}
            onPress={() => {
              setSource(searchFrom.naver);
              handleOnPress();
            }}
          />
        </Animated.View>
...
const mapDispatchToProps = dispatch => ({
  setAPIsource: source => {
    console.log(source);
    dispatch(newsActions.setAPIsource(source));
  },
});
